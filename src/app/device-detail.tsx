  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          onPress={() =>
            router.push({ pathname: "/edit-device", params: { id } })
          }
        >
      ...
      <View style={styles.heroCard}>
        <View style={styles.heroIcon}>
          <Smartphone color={COLORS.primary} size={40} />
        </View>
        ...
        <View style={[styles.badge, !device.is_active && styles.badgeInactive]}>
          <Text
            style={[
              styles.badgeText,
              !device.is_active && styles.badgeTextInactive,
            ]}
          >
      ...
      <View style={styles.section}>
        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>{device.code}</Text>
          </View>
          <View style={styles.infoRow}>
            <CreditCard size={16} color={COLORS.textMuted} />
            <Text style={styles.infoText}>E-Wallet: {device.ewallet}</Text>
          </View>
          {device.phone_number ? (
            <View style={styles.infoRow}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.metricTabs}>
          <TouchableOpacity
            onPress={() => setMetricTab("Pemasukan")}
            style={[styles.metricTab, isIncome && styles.metricTabActive]}
          >
            <Text
              style={[styles.metricText, isIncome && styles.metricTextActive]}
            >
              Pemasukan
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => setMetricTab("Penarikan")}
            style={[styles.metricTab, !isIncome && styles.metricTabActive]}
          >
            <Text
              style={[styles.metricText, !isIncome && styles.metricTextActive]}
